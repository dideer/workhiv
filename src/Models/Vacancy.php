...
class Vacancy
{
    ...
    public function create(array $data): int
    {
        $stmt = $this->db->prepare(
            'INSERT INTO vacancies (company_id, title, description, location, salary_range, deadline, status)
             VALUES (:company_id, :title, :description, :location, :salary_range, :deadline, :status)'
        );
