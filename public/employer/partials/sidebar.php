<aside class="admin-sidebar" aria-label="Employer navigation">
    ...
    <nav class="admin-nav">
        ...
        <a class="admin-nav-link <?php echo $activePage === 'exchange-requests' ? 'is-active' : ''; ?>" href="exchange-requests.php" <?php echo $activePage === 'exchange-requests' ? 'aria-current="page"' : ''; ?>>
